...
Phase 10.1, this decision, does not scaffold the site yet. Follow-up issues own
the implementation:

- Phase 10.2: create `site/` and migrate existing docs into the chosen IA.
...
- Phase 10.6: build, publish, and versioning pipeline.
