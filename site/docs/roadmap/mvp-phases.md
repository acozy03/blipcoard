...
- cross-platform manual checks for screenshots, copied images, file lists, HTML,
  ...
  [rich-payload-reliability.md](../architecture/storage-and-blobs.md)
...
- config, data, blob, IPC, first-run, startup, and uninstall expectations are
  documented in [runtime-distribution.md](../operations/runtime-distribution.md)
...
- platform signing, installer, package, update, and smoke-test expectations are
  documented in [desktop-bundles.md](../operations/desktop-bundles.md)
...
- Docusaurus classic preset as the docs site generator, following
  `docs/docs-site-architecture.md`
